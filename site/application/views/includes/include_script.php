...
<script type="text/javascript" src="<?=base_url("assets/")?>plugins/rs-plugin-5/js/jquery.themepunch.tools.min.js?rev=5.0"></script>
<script type="text/javascript" src="<?=base_url("assets/")?>plugins/rs-plugin-5/js/jquery.themepunch.revolution.min.js?rev=5
.0"></script>
<!-- Isotope javascript -->
...
<script type="text/javascript" src="<?=base_url("assets/")?>plugins/owlcarousel2/owl.carousel.min.js"></script>
<!-- Pace javascript -->
