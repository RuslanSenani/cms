                    ...
                    <div class="col-md-3">
                        <div class="footer-content">
                            ...
                            <div class="media margin-clear">
                                <div class="media-left">
                                    <div class="overlay-container">
                                        <img class="media-object" src="<?=base_url("assets/images");?>/blog-thumb-1.jpg" alt="blog-thumb">
                            ...
                            <div class="media margin-clear">
                                <div class="media-left">
                                    <div class="overlay-container">
                                        <img class="media-object" src="<?=base_url("assets/images");?>/blog-thumb-2.jpg" alt="blog-thumb">
                                        <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media margin-clear">
                                <div class="media-left">
                                    <div class="overlay-container">
                                        <img class="media-object" src="<?=base_url("assets/images");?>/blog-thumb-3.jpg" alt="blog-thumb">
                                        <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media margin-clear">
                                <div class="media-left">
                                    <div class="overlay-container">
                                        <img class="media-object" src="<?=base_url("assets/images");?>/blog-thumb-4.jpg" alt="blog-thumb">
                                        <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="row grid-space-10">
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-1.jpg" alt="">
                                ...
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-2.jpg" alt="">
                                        <a href="portfolio-item.html" class="overlay-link small">
                                            <i class="fa fa-link"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-3.jpg" alt="">
                                        <a href="portfolio-item.html" class="overlay-link small">
                                            <i class="fa fa-link"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-4.jpg" alt="">
                                        <a href="portfolio-item.html" class="overlay-link small">
                                            <i class="fa fa-link"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-5.jpg" alt="">
                                        <a href="portfolio-item.html" class="overlay-link small">
                                            <i class="fa fa-link"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-xs-4 col-md-6">
                                    <div class="overlay-container mb-10">
                                        <img src="<?=base_url("assets/images");?>/gallery-6.jpg" alt="">
                                        <a href="portfolio-item.html" class="overlay-link small">
                                            <i class="fa fa-link"></i>
                                        </a>
                                    </div>
