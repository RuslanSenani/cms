        ...
        <?php foreach ($item_images as $image) { ?>
            <tr id="ord-<?= $image->id; ?>">
                ...
                <td class="w100 text-center">
                    <input data-url="<?= base_url("portfolio/imageIsActiveSetter/$image->id"); ?>" class="isActive" id="" type="checkbox"
                           data-switchery data-color="#10c469" <?= ($image->isActive) ? "checked" : ""; ?> />
                </td>
                <td class="w100 text-center">
                    <input data-url="<?= base_url("portfolio/isCoverSetter/$image->id/$image->portfolio_id"); ?>" class="isCover" id=""
                           type="checkbox" data-switchery data-color="#ff5b5b" <?= ($image->isCover) ? "checked" : ""; ?> />
                </td>
                <td class="w100 text-center">
                    <button data-url="<?= base_url("portfolio/imageDelete/$image->id/$image->portfolio_id"); ?>"
