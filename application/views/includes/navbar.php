...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
    ...
    <div class="navbar-header">
        ...
        <button type="button" class="navbar-toggle navbar-toggle-right collapsed" data-toggle="collapse" data-target="#navbar-search"
                aria-expanded="false">
            <span class="sr-only">Toggle navigation</span>
        ...
        <a href="../index.html" class="navbar-brand">
            <span class=" avatar  avatar-xs avatar-circle">
                <img class="img-responsive"
                     src="<?= ($settings->logo !== "default") ? base_url("uploads/settings_v/$settings->logo") : "https://source.unsplash.com/collection/random/300x300"; ?>"
            ...
            <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><i class="zmdi zmdi-hc-lg zmdi-notifications"></i></a>
