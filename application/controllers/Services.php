...
class Services extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $items = $this->service_model->get_all(array(), array("rank", "ASC"));
    ...
    public function insert()
    {
        ...
        if ($validation) {
            ...
            if ($upload) {
                ...
                $insert = $this->service_model->insert(array(
    ...
    public function update_form($id)
    {
        ...
        $viewData = new stdClass();
        /* Bazadan Products Table-den Datalarin getirilmesi*/
        $item = $this->service_model->get(array(
            "id" => $id
        ));
    ...
    public function update($id)
    {
        ...
        if ($validation) {
            ...
            $viewData->subViewFolder = "update";
            $viewData->form_error = true;
            $viewData->item = $this->service_model->get(array(
                "id" => $id
            ));
            $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
        }
    ...
    {
        $delete = $this->service_model->delete(array(
            "id" => $id
        ));
        if ($delete) {
            $alert = array(
    ...
    public function isActiveSetter($id)
    {
        ...
        if ($id) {
            ...
            $this->service_model->update(array(
                "id" => $id
            ), array(
                "isActive" => $isActive
            ));
